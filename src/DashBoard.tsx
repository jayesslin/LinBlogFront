...
axios.get('/hello/',
    ...
    .then(function (response) {
        console.log("[python]端代码：",response);
    })
    .catch(function (error) {
        console.log("[python]请求失败",error);
    });
...
export class DashBoard extends React.Component<any,DashBoardState>{
    ...
    upload=()=>{
        ...
        let para = {'projectdesc':projectdesc,'projectname':projectname,'wechatname':wechatname,'phone':phone};
        axios.defaults.baseURL="http://localhost:5000";
        console.log("canshu",projectname,projectdesc);
        axios.post('/upload/',para
        )
            .then(function (response) {
    ...
    render(): React.ReactElement<any, string | React.JSXElementConstructor<any>> | string | number | {} | React.ReactNodeArray | React.ReactPortal | boolean | null | undefined {
        return <div>
            ...
            <Form  labelCol={{ span: 5 }} wrapperCol={{ span: 12 }}  style={{marginTop:"3%"}}>
            <Form.Item label="项目名">
